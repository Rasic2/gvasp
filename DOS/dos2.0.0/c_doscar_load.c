 ...
 */
      ...
      __pyx_t_3 = PyUnicode_Split(__pyx_v_line, ((PyObject *)NULL), -1L); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_9 = __Pyx_PyObject_GetSlice(__pyx_t_3, 1, 0, NULL, NULL, &__pyx_slice__3, 1, 0, 1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (likely(PyList_CheckExact(__pyx_t_9)) || PyTuple_CheckExact(__pyx_t_9)) {
        ...
        __pyx_t_15 = -1; __pyx_t_3 = PyObject_GetIter(__pyx_t_9); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_16 = Py_TYPE(__pyx_t_3)->tp_iternext; if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 31, __pyx_L1_error)
      }
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      for (;;) {
        if (likely(!__pyx_t_16)) {
          if (likely(PyList_CheckExact(__pyx_t_3))) {
            ...
            #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
            __pyx_t_9 = PyList_GET_ITEM(__pyx_t_3, __pyx_t_15); __Pyx_INCREF(__pyx_t_9); __pyx_t_15++; if (unlikely(0 < 0)) __PYX_ERR(0, 31, __pyx_L1_error)
            #else
            __pyx_t_9 = PySequence_ITEM(__pyx_t_3, __pyx_t_15); __pyx_t_15++; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_9);
            #endif
          } else {
            if (__pyx_t_15 >= PyTuple_GET_SIZE(__pyx_t_3)) break;
            #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
            __pyx_t_9 = PyTuple_GET_ITEM(__pyx_t_3, __pyx_t_15); __Pyx_INCREF(__pyx_t_9); __pyx_t_15++; if (unlikely(0 < 0)) __PYX_ERR(0, 31, __pyx_L1_error)
            #else
            __pyx_t_9 = PySequence_ITEM(__pyx_t_3, __pyx_t_15); __pyx_t_15++; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_9);
            #endif
        ...
        __pyx_t_7 = __Pyx_PyObject_AsString(__pyx_v_item); if (unlikely((!__pyx_t_7) && PyErr_Occurred())) __PYX_ERR(0, 31, __pyx_L1_error)
        __pyx_t_9 = PyFloat_FromDouble((atof(__pyx_t_7) * __Pyx_pow_long(-1L, ((long)__pyx_v_index)))); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 31, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_9);
 ...
 * 		list atom_list=[],DATA_list=[],line_array,Total_up=[],Total_down=[],energy_list=[]
 */
  __pyx_tuple__5 = PyTuple_Pack(14, __pyx_n_s_DOSCAR, __pyx_n_s_atom_list, __pyx_n_s_DATA_list, __pyx_n_s_line_array, __pyx_n_s_Total_up, __pyx_n_s_Total_down, __pyx_n_s_energy_list, __pyx_n_s_var, __pyx_n_s_NEDOS, __pyx_n_s_count, __pyx_n_s_index, __pyx_n_s_E_Fermi, __pyx_n_s_line, __pyx_n_s_item); if (unlikely(!__pyx_tuple__5)) __PYX_ERR(0, 12, __pyx_L1_error)
