...
def main(option):
	...
	P=list(P)
	print("文件加载完成...")
	#P[0].center(atoms=[28,29],orbitals=None,xlim=[-2.5,10])
	#P[1].center(atoms=[30,31],xlim=[-2.5,10])
	#P[2].center(atoms=[35,36],xlim=[-2.5,10])
	#P[3].center(atoms=[32,33],xlim=[-2.5,10])
	P[0].plot(atom=[28,29],xlim=[-0.8,0.2],color='#F69221',method='fill')
	#P[1].plot(atom=[30,31],xlim=[-0.8,0.2],color='#ed0345')
	#P[2].plot(atom=[35,36,49],xlim=[-1.5,2],color='#F69221')
	#P[3].plot(atom=[32,33,49],xlim=[-1.5,2],color='#000000')
	#P[0].plot(atom=36,xlim=[-35,0],color='#ed0345')
	#P[1].plot(atom=39,xlim=[-35,0],color='#F69221')
	#P[2].plot(atom=41,xlim=[-35,0],color='#3A7F99')
	#plt.text(-0.73,2.5,r'$O_2^{δ-}$',fontsize=14)
	#plt.text(-0.15,-2.5,r'$O_2^{δ-}$',fontsize=14)
	#plt.text(-0.8,4.5,r'$π^*$',fontsize=16)
	#plt.text(-0.25,-7,r'$π^*$',fontsize=16)
	#P[0].plot(xlim=[-1.5,0],color='#000000')
