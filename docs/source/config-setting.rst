...
* :file:`INCAR`: INCAR template file of all :program:`QVasp` submit tasks, default parameters, :download:`INCAR <./INCAR>`
...
Then the environment will be reset, :program:`QVasp` will auto search the :file:`INCAR`, :file:`UValue.yaml`, :file:`pot` under the config_dir.